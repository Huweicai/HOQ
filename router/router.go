...
var notFoundResp = hoq.FastResponse(hoq.StatusNotFound, hoq.NewHeaders(map[string]string{"Server": ServerName}))
var innerErrResp = hoq.FastResponse(hoq.StatusInternalServerError, hoq.NewHeaders(map[string]string{"Server": ServerName}))
